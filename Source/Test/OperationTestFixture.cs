...
namespace Rivet.Test
{
    ...
    internal sealed class OperationTestFixture
    {
        ...
        [Test]
        public void ShouldMergeIfOperationDisabled()
        {
        ...
        public void ShouldAutomaticallyRemoveAddOperation()
        {
            var addOps = new Operation[]
            {
                ...
                new AddForeignKeyOperation("schema", "table", new string[0], "ref schema", "ref table", new string[0], "name", "on delete", "on update", false, false), 
            ...
            var items = (new string[0]).Where(o => o != null);
            ...
            Assert.That(missingOps, Is.Empty, $"Missing instances of types that have {typeof(ObjectRemovedByOperationAttribute)}");
