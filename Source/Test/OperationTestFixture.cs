	...
	internal sealed class OperationTestFixture
	{
		...
		public void ShouldAutomaticallyRemoveAddOperation()
		{
			var addOps = new Operation[]
			{
				...
				new AddForeignKeyOperation("schema", "table", new string[0], "ref schema", "ref table", new string[0],
					"name", "on delete", "on update", false, false),
				new AddIndexOperation("schema", "table", new string[0], "name", false, false, new string[0], "where",
					"on", "file stream on", new string[0]),
				new AddPrimaryKeyOperation("schema", "table", new string[0], "name", false, new string[0]),
				...
				new AddSynonymOperation("schema", "name", "target schema name", "target database name",
					"target object name"),
				new AddTableOperation("schema", "name", new Column[0], false, "file group", "text image file group",
					"file stream file group", new string[0]),
				new AddTriggerOperation("schema", "name", "definition"),
				new AddUniqueKeyOperation("schema", "table", new string[0], "name", false, 0, new string[0],
					"file group"),
