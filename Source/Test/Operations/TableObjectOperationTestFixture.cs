	...
	internal sealed class TableObjectOperationTestFixture
	{
		...
		public void ShouldDisableRenameOperationAndUpdateTableNameWhenRenamingTable()
		{
			var tableObjectOps = new TableObjectOperation[]
			{
				...
				new AddForeignKeyOperation("schema", "name", new string[0], "referencesschema", "referencestable",
					new string[0], "key", "ondelete", "onupdate", false, false),
				new AddIndexOperation("schema", "name", new string[0], "index", false, false, new string[0], "where",
					"on", "filestreamon", new string[0]),
