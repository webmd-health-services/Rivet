namespace Rivet.Operations
{
	public sealed class RemoveIndexOperation : Operation
	{
		...
		public RemoveIndexOperation(string schemaName, string tableName, string[] columnName, string customConstraintName)
		{
		...
		public override string ToQuery()
		{
			...
			return string.Format("drop index [{0}] on [{1}].[{2}]", ConstraintName, SchemaName, TableName);
