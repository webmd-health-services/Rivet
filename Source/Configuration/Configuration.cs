...
namespace Rivet.Configuration
{
	...
	{
		public Configuration(string path, string environment, string sqlServerName, string databasesRoot, int connectionTimeout, int commandTimeout, string[] pluginPaths, string[] pluginModules)
		{
			Path = path;
			...
			PluginModules = pluginModules ?? new string[0];
		...
		public string[] PluginModules { get; private set; }
