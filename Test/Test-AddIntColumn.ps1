...
function Test-ShouldCreateIntColumnNonDataTypeSpecific
{
    @'
...
'@ | New-Migration -Name 'CreateIntColumnNonDataTypeSpecific'

    Invoke-Rivet -Push 'CreateIntColumnNonDataTypeSpecific'
