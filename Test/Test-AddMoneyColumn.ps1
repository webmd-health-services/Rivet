...
function Test-ShouldCreateMoneyColumnNonDataTypeSpecific
{
    @'
...
'@ | New-Migration -Name 'CreateMoneyColumnNonDataTypeSpecific'

    Invoke-Rivet -Push 'CreateMoneyColumnNonDataTypeSpecific'
